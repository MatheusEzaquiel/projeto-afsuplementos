...
<body>
                ...
                <nav class="navbar navbar-expand-lg py-3 py-lg-0 px-0" style="background-color: #000000;margin-top: 0.7em;margin-right: 3em;">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="index.html" class="nav-item nav-link active" style="color: #F9F6F6;">Home</a>
                            <a href="shop.html" class="nav-item nav-link" style="color: #F9F6F6;">Catálogo</a>
                            ...
                            <a href="contact.html" class="nav-item nav-link" style="color: #F9F6F6;">Contact</a>
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    <h1 class="fas fa-exchange-alt  m-0 mr-3" style="color:#DF0805;"></h1>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3" style="color: #000000;">Mais procurados</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
    ...
    <!-- Products Start -->
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3" style="color: #000000;">Categorias</span></h2>
        <div class="row px-xl-5">
            <div class="col">
    ...
    <div class="container-fluid py-5">
        <div class="row px-5">
            <div class="col-md-6">
                <div class="product-offer" style="height: 300px;width: 1270px;">
                    <img class="img-fluid" src="img/offer-1.jpg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">Save 20%</h6>
                        <h3 class="text-white mb-3">Produto Específico</h3>
