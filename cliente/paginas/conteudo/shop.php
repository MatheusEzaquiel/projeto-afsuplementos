                                ...
                                <div class="product-item bg-light mb-4">
                                    <div class="product-img position-relative overflow-hidden">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a class="btn btn-outline-dark btn-square" href="home.php?pagina=carrinho&add=carrinho&id=<?php echo $produto['id_produto']?>" name="btn-carrinho<?php echo $idProduto;?>"><i class="fa fa-shopping-cart"></i></a>
                                            <a class="btn btn-outline-dark btn-square" href="home.php?pagina=detalhes&idDetail=<?php echo $produto['id_produto']?>"><i class="fa fa-search"></i></a>
                                        </div>
                                    ...
                                    <div class="text-center py-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mt-2">
                                            <h5>R$ <?php echo number_format($produto['preco_venda_produto'],2, ",", ".");?></h5><h6 class="text-muted ml-2"></h6>
                                        </div>
                                    </div>
                                </div>
