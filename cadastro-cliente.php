        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-6">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    if(isset($_POST['btnRegistro'])){
                      ...
                      */
                        ...
                        if($senha == $confSenha){
                            ...
                            $cadastro = "INSERT INTO tb_cliente (nome_cliente, email_cliente, senha_cliente,telefone_cliente) VALUES (:nome,:email,:senha,:telefone)";
                            ...
                            try{
                                ...
                                echo '<div class="container">
                                        ...
                                        echo "<script>
                                                    setTimeout(function() {
                                                        window.location.replace('cadastro-cliente.php');
                                                    }, 1000)
                                                </script>";
                                }
                            ...
                            echo '<div class="container">
                                    <div class="alert alert-danger alert-dismissible">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        <h5><i class="icon fas fa-check"></i> Ops!</h5>
                                            Erro! confirme a senha novamente
                                    </div>
                                </div>';
                        }
                    ...
                    /*
                    Código p/ add imagem do cliente
