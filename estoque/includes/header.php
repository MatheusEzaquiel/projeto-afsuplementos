                                ...
                                <i class="fa fa-bell" style="color:#DF0805;"></i>
                                    ...
                                    <div class="dropdown-menu rounded-0 border-0 m-0">
                                        ...
                                        <?php
                                            ...
                                            //Select das informações do admin logado

                                            $emailLogado = $_SESSION['emailLogin'];
                                            $senhaLogado = base64_encode($_SESSION['senhaLogin']);

                                          


                                            
                                            $selectAdmin = "SELECT * FROM tb_admin WHERE email_admin = :emailAdminLogado AND senha_admin = :senhaAdminLogado";
                                            
                                            try {
                                                $resultAdmin = $conect->prepare($selectAdmin);
                                                $resultAdmin->bindParam(":emailAdminLogado",$emailLogado,PDO::PARAM_STR);
                                                $resultAdmin->bindParam(":senhaLogado",$senhaLogado,PDO::PARAM_STR);
                                                $resultAdmin->execute();

                                                $contAdmin = $resultAdmin->rowCount();
                                                

                                                if($contAdmin > 0){
                                                    while($adminLogado = $resultAdmin->FETCH(PDO::FETCH_OBJ)){

                                                        $idAdmin = $adminLogado->id_cliente;
                                                        $nomeAdmin = $adminLogado->nome_cliente;
                                                        $emailAdmin = $adminLogado->email_cliente;
                                                        $senhaAdmin = $adminLogado->senha_cliente;
                                                        $foneAdmin = $adminLogado->telefone_cliente;
                                            ...
                                            //VERIFICAR SE ESSES SELECTS SÃO NECESSÁRIOS
