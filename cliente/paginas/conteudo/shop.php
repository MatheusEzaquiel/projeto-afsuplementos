                    ...
                    <div class="row pb-3">
                        ...
                        <div class="col-12 pb-1">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div class="ml-2">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Filtrar</button>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="?pagina=shop&filtro=1" >Atuais</a>
                                                <a class="dropdown-item" href="?pagina=shop&filtro=2" >Mais baratos</a>
                                            </div>
                                        </div>  
                                    </div>
                        ...
                        <?php
                            ...
                            if(isset($_GET["filtro"])){
                                ...
                                if($filtroP == 1){
                                    ...
                                    //Ordenação, produtos mais baratos p/ os mais caros
